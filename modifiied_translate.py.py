...
def get_parser():
    ...
    parser.add_argument("--BPE_path", type=str,
                        default="/content/drive/MyDrive/TransCoder/data/BPE_with_comments_codes", help="Path to BPE codes.")
...
class Translator:
    def __init__(self, params):
        ...
        def embedding(input_code):
          preprocessed_text = reloaded['encoder']
    ...
    def translate(self, input, lang1, lang2, n=1, beam_size=1, sample_temperature=None, device='cuda:0'):
        with torch.no_grad():
            ...
            torch.save(enc1, '/content/singleton1.pt')
...
if __name__ == '__main__':
    ...
    sys.stdin = open('/content/singleton_1.cpp', 'r')
    input = sys.stdin.read().strip()
    ...
    with torch.no_grad():
        ...
        #a = translator.__init__.embedding(input)
    for out in output:
